...
import lemon_juice.scalar_utils.screen.slot.ModResultSlot;
...
public class ManaCondenserMenu extends AbstractContainerMenu {
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 2;  //Number of slots in Tile
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.MANA_CONDENSER.get());
    }
