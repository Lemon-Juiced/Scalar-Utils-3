...
public class ModPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> MANA_CRYSTAL_ORE_PLACED = PlacementUtils.register("mana_crystal_ore_placed", ModConfiguredFeatures.MANA_CRYSTAL, ModOrePlacement.rareOrePlacement(3, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
