...
public class ModPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> FLUX_ORE_PLACED = PlacementUtils.register("flux_ore_placed", ModConfiguredFeatures.FLUX_ORE, ModOrePlacement.rareOrePlacement(3, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
