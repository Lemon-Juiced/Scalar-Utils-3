...
public class ManaCondenserRecipe implements Recipe<SimpleContainer> {
    ...
    public ManaCondenserRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems){
        this.id = id;
        this.output = output;
    ...
    public static class Type implements RecipeType<ManaCondenserRecipe>{
        ...
        public static final String ID = "mana_condensing";
    }

    public static class Serializer implements RecipeSerializer<ManaCondenserRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(ScalarUtils.MOD_ID,"mana_condensing");
